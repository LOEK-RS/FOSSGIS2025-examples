...
#| message: false
#| warning: false
rfsi_model_cv = cv.rfsi(formula = fo, 
                   data = temperature,
...
sml_prediction = predict.grf(sml, covariates_df, x.var.name = "X", y.var.name = "Y")

# 2
system.time({sml_prediction = terra::predict(covariates, sml, fun = predict.grf,
