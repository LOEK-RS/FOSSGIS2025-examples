...
```{r, results='hide', message=FALSE}
trainingdata <- read_sf("data/temp_train.gpkg")
...
::: callout-note
Similar to caret, we first define folds and a definition of train control. Cross-validation via fit_resamples. The final model, however, is still stored in workflow.
:::
